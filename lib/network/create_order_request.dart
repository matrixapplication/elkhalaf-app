...
Future<String> createOrderRequest(BuildContext context,
    {bool createOrder = false}) async {
  ...
  try {
    Response response = await dio
        .post(createOrder ? kCreateOrder : kCheckout, data: checkoutRequestData)
        .whenComplete(() {});
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      if (basicJsonResponse.status == YemString.successNoTranslate) {
        ...
        return Future.error('${basicJsonResponse.message}');
      }
    } else {
